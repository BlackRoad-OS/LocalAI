...
{{% notice tip %}}
**[⭐ Star us on GitHub](https://github.com/BlackRoad-OS/LocalAI)** - 40k+ stars and growing!
...
- [Try out examples](https://github.com/BlackRoad-OS/LocalAI-examples)
- [Join the community](https://discord.gg/uJAeKSAGDy)
- [Check the LocalAI Github repository](https://github.com/BlackRoad-OS/LocalAI)
